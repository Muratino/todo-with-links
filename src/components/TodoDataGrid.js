...
const TodoDataGrid = ({ columns }) => {
  ...
  const { createTask, todos, complatedTasks, isFiltering, filterTodos } =
      ...
      <div className="parent">
        ...
        <div className="parent__body">
          <div className="parent__body-task">
            ...
            />
            <button className="parent__body-button" onClick={createNewTask}>
              Create
            </button>
          </div>
          ...
          <div className="completed__tasks completed">
            {complatedTasks.map((el) => (
              <CompletedTask key={el.id} {...el} />
            ))}
          </div>
        </div>
      </div>
